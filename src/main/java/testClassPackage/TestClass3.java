...
import pageObjectsPackage.SentPage;
...
public class TestClass3 {
	...
	public void sentFolder(String username, String password) throws Exception  {
		SentPage.verifySentFolder(driver, username, password);
	}
