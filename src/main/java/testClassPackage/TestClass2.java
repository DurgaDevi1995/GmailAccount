...
import pageObjectsPackage.InboxPage;
...
public class TestClass2 {
	...
	public void inboxMailCount(String username, String password) throws Exception  {
		InboxPage.verifyMailCount(driver, username, password);
	}
